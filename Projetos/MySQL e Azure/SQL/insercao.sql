...
-- Desabilitar as verificações de chaves estrangeiras temporariamente
SET foreign_key_checks = 0;

-- Inserir todos os funcionários de uma vez
...
-- Reabilitar as verificações de chaves estrangeiras
